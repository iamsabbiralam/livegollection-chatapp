 ...
 */
function isUpdateMessage(updMess) {
...
export default class LiveGollection {
    ...
    constructor(url) {
        this.url = url;
        this.hasConnBeenOpened = false;
        this.hasConnBeenClosed = false;
        ...
        this.isOnCreateSet = false;
        this.isOnUpdateSet = false;
        this.isOnDeleteSet = false;
        this.isOnOpenSet = false;
        this.isOnCloseSet = false;
     ...
     */
    craftAndSendUpdateMessage(item, method) {
        let updMess = {
            method: method,
            item: item
        };
...
LiveGollection.createMethodString = "CREATE";
LiveGollection.updateMethodString = "UPDATE";
LiveGollection.deleteMethodString = "DELETE";
